...
// built and kept by Intelligence, and this tool asks for answers rather than
...
// now names **handles** — `gm_` plus ten hex characters, issued by Intelligence.
...
/** A handle as Intelligence issues it. Opaque by construction. */
 ...
 *
 * `known` is optional and comes from Intelligence when this machine is
 ...
 * node in the blast radius. Without it — no account, or Intelligence not
